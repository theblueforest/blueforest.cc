  ...
  render: ({ props }) => {
    ...
    return <Kiwi.Container style={MethodLayoutStyle.container}>
      <Kiwi.Container style={MethodLayoutStyle.content}>
        ...
        <Kiwi.Image source={uxImage} alt={i18nMethod.uxImageAlt.fr} style={MethodLayoutStyle.uxImg}/>
        ...
        <Kiwi.Image source={explorationImage} alt={i18nMethod.explorationImageAlt.fr} style={MethodLayoutStyle.explorationImage}/>
        ...
        <Kiwi.Image source={conceptionImage} alt={i18nMethod.conceptionImageAlt.fr} style={MethodLayoutStyle.conceptionImage}/>
